package com.ustglobal.springmvcproduct.controller;
...
import com.ustglobal.springmvcproduct.service.ProductService;
...
public class ProductController {
	...
	@PostMapping("/search")
	public String searchproduct(@SessionAttribute(name = "user", required = false) User user, ModelMap map,
			String pname) {
		if (user != null) {
	...
	@PostMapping("/buy")
	public String buyproduct(@SessionAttribute(name = "user", required = false) User user, ModelMap map,
